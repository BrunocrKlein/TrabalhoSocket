 ...
 */
public class ScreenPifPaf extends javax.swing.JFrame {
	public static int identificador = 0;
	/**
	 * Creates new form Screentes
	 */
	public ScreenPifPaf() {
		initComponents();
	}
...
///	identificador += 1;
     //    String[] port = {"5006", Integer.toString(identificador)};
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(ScreenPifPaf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new ScreenPifPaf().setVisible(true);
			}
		});
	}
